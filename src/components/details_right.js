      ...
      <div className="w-1/2">
        <div className="relative w-full h-full">
          <div className="absolute inset-0 flex justify-end items-center">
            <div className="mr-52 w-[350px] h-[350px] rounded-full border border-gray-600 border-dashed"></div>
          </div>
          <div className="absolute inset-0 flex justify-end items-center">
            <div className="mr-64 w-[250px] h-[250px] rounded-full border border-gray-600 border-dashed"></div>
          </div>
          <div className="absolute inset-0 flex justify-end items-center">
      ...
      <div className="w-1/2">
        <div className="relative w-full h-full">
          ...
          <div className="absolute inset-0 flex justify-end items-start">
            <div className="mr-5 w-[70px] h-[70px] rounded-tr-full bg-gradient-to-r from-cyan-500 to-blue-500"></div>
          </div>
          <div className="absolute inset-0 flex justify-end items-start">
            <Image
              className="mr-28"
